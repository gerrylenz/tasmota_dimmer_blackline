...
const mytmplt kModules[MAXMODULE] PROGMEM = {
  ...
  { "EXS Blackline",   // EXS_Blackline - ES-Store Latching relay(s) (ESP8266)
                       // https://ex-store.de/2-Kanal-WiFi-WLan-Relay-V5-Blackline-fuer-Unterputzmontage
     GPIO_USER,        // GPIO00 V5.0 Module Pin 4
     0,                // GPIO01 UART0_TXD
     GPIO_USER,        // GPIO02 V5.0 Module Pin 3
     0,                // GPIO03 UART0_RXD
     GPIO_USER,        // GPIO04 V5.0 Module Pin 2
     GPIO_USER,        // GPIO05 V5.0 Module Pin 1
                       // GPIO06 (SD_CLK   Flash)
                       // GPIO07 (SD_DATA0 Flash QIO/DIO/DOUT)
                       // GPIO08 (SD_DATA1 Flash QIO/DIO/DOUT)
     0,                // GPIO09 (SD_DATA2 Flash QIO or ESP8285)
     ...
     GPIO_REL1,        // GPIO12 Relay1 ( 1 = Off)
     GPIO_REL2,        // GPIO13 Relay1 ( 1 = On)
     GPIO_REL3_INV,    // GPIO14 V5.0 GPIO_REL3_INV Relay2 ( 1 = Off)
     GPIO_LEDLNK,      // GPIO15 V5.0 LED1 - Link and Power status
     GPIO_REL4_INV,    // GPIO16 V5.0 GPIO_REL4_INV Relay2 ( 1 = On)
     0
  },
