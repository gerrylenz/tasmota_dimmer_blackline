...
//#define USE_CONFIG_BLACKLINE                      // Uncomment to use config_blackline.h file. See README.md
#define USE_CONFIG_DIMMER                      // Uncomment to use config_dimmer.h file. See README.md
...
#define SUB_PREFIX             "IN"            // [Prefix1] Sonoff devices subscribe to %prefix%/%topic% being SUB_PREFIX/MQTT_TOPIC and SUB_PREFIX/MQTT_GRPTOPIC
...
#define MQTT_GRPTOPIC          ""                // [GroupTopic] MQTT Group topic
...
#define FRIENDLY_NAME          ""          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#ifdef USE_CONFIG_BLACKLINE
  #include "config_blackline.h"         // Configuration overrides for my_user_config.h
#endif
#ifdef USE_CONFIG_DIMMER
  #include "config_dimmer.h"         // Configuration overrides for my_user_config.h
#endif
