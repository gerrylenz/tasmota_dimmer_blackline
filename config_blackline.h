...
#ifndef _CONFIG_BLACKLINE_H_
#define _CONFIG_BLACKLINE_H_

// force the compiler to show a warning to confirm that this file is included
#warning **** config_blackline.h: Using Settings from this File ****
...
\*****************************************************************************************************/
#undef  MODULE
#define MODULE                 EXS_Blackline        // [Module] Select default model from sonoff_template.h

#undef  PROJECT
#define PROJECT                "BLACKLINE"      // PROJECT is used as the default topic delimiter

#undef  FRIENDLY_NAME
#define FRIENDLY_NAME          "EXS_Blackline"      // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#undef  MQTT_GRPTOPIC
#define MQTT_GRPTOPIC          "blackline"          // [GroupTopic] MQTT Group topic
